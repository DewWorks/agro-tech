...
export function ProducerPropertyStep({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {!initialData?.id ? (
        <div className="col-span-1 md:col-span-2 space-y-3 p-5 border-2 border-emerald-200 rounded-2xl bg-linear-to-b from-emerald-50/50 to-white shadow-xs">
          <div className="flex items-start gap-3">
            <div className="h-10 w-10 rounded-xl bg-[#1B4D3E] text-white flex items-center justify-center font-bold shadow-xs shrink-0 mt-0.5">
              <MapPin className="h-5 w-5" />
            </div>
            <div className="space-y-1">
              <h3 className="text-base font-bold text-gray-900 flex items-center gap-2">
                Primeira Propriedade Rural
        ...
        <div className="col-span-1 md:col-span-2 space-y-4 p-5 border-2 border-emerald-200 rounded-2xl bg-linear-to-b from-emerald-50/50 to-white shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-emerald-100">
            ...
            <Link href={`/admin/crm/properties/new?producerId=${initialData.id}&branchId=${initialData.branchId || ''}`}>
